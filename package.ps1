$SourceDir = "C:\Users\User\Desktop\MAUZER"
$ReleaseDir = "C:\Users\User\Desktop\MAUZER_Release"
...
$Exclude = @("node_modules", "dist", ".cache", ".agent", "MAUZER_Release", ".git", "package.ps1")
Get-ChildItem -Path $SourceDir -Exclude $Exclude | Copy-Item -Destination "$ReleaseDir\Source" -Recurse -Force

# Copy compiled executable
Copy-Item -Path "$SourceDir\dist\Mauzer-1.0.0.exe" -Destination "$ReleaseDir\Compiled\Mauzer-1.0.0.exe" -Force
